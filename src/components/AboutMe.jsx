        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              ...
              functional user experiences. With a background in design and
              development, I bring a unique perspective to every project.
            </p>

            <p className="text-muted-foreground">
              I believe in the power of collaboration and communication to
              create the best possible outcomes for my clients and users.
            </p>
